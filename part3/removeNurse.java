...
import java.awt.event.*; 
 ...
 public class removeNurse extends FinalProjectApp{
	 
	public void deleteNurse(int akey){
		super.NurseCatalogGet().remove(akey);
	}
	public  void remove (){
		...
		JFrame frame4 = new JFrame("remove nurse window");
		...
		JLabel title = new JLabel("****************DELETE NURSE*****************");
		...
		@Override
		 public void actionPerformed(ActionEvent e){
			...
			deleteNurse(Integer.parseInt(recordedID));
